package jp.naorin.yarnshelf.common
...
fun yarnDataToYarnDataForScreenConverter(yarnData: YarnData): YarnDataForScreen {
    return YarnDataForScreen(
        ...
        weight = if (yarnData.weight != null) DecimalFormat("#.#").format(yarnData.weight) else "",
        roll = yarnData.roll,
        length = if (yarnData.length != null) DecimalFormat("#.#").format(yarnData.length) else "",
        gaugeColumnFrom = if (yarnData.gaugeColumnFrom != null) DecimalFormat("#.#").format(yarnData.gaugeColumnFrom) else "",
        gaugeColumnTo = if (yarnData.gaugeColumnTo != null) DecimalFormat("#.#").format(yarnData.gaugeColumnTo) else "",
        gaugeRowFrom = if (yarnData.gaugeRowFrom != null) DecimalFormat("#.#").format(yarnData.gaugeRowFrom) else "",
        gaugeRowTo = if (yarnData.gaugeRowTo != null) DecimalFormat("#.#").format(yarnData.gaugeRowTo) else "",
        gaugeStitch = yarnData.gaugeStitch,
        needleSizeFrom = if (yarnData.needleSizeFrom != null) DecimalFormat("#.#").format(yarnData.needleSizeFrom) else "",
        needleSizeTo = if (yarnData.needleSizeTo != null) DecimalFormat("#.#").format(yarnData.needleSizeTo) else "",
        crochetNeedleSizeFrom = if (yarnData.crochetNeedleSizeFrom != null) DecimalFormat("#.#").format(yarnData.crochetNeedleSizeFrom) else "",
        crochetNeedleSizeTo = if (yarnData.crochetNeedleSizeTo != null) DecimalFormat("#.#").format(yarnData.crochetNeedleSizeTo) else "",
